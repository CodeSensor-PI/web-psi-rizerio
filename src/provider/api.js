...
export const visualizarAgendamentos = async (idUsuario) => {
    try {
        const response = await axios.get(`http://localhost:3000/sessao?idUsuario=${idUsuario}`);
        return response.data;
    } catch (error) {
...
export const atualizarAgendamento = async (idAgendamento, dadosAtualizados) => {
    try {
        const response = await axios.patch(`http://localhost:3000/sessao/${idAgendamento}`, dadosAtualizados);
        return response;
    } catch (error) {
...
export const buscarAgendamentoPorId = async (idAgendamento) => {
    try {
        const response = await axios.get(`http://localhost:3000/sessao/${idAgendamento}`);
        return response.data;
    } catch (error) {
